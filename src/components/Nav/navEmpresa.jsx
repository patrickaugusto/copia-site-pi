...
import logoempresa from "/src/imagem/logoEmpresa.png"
      ...
      <nav className={'navbar navbar-expand-lg navbar-light px-5 py-2 shadow-sm p-3 rounded ${colorMode === "light" ? "bg-white" : "bg-gray-800"}'}>
        <div className="container">
          <Link className="navbar-brand" to="/">
            <img src={logoempresa} alt="Emprega Embarque" style={{ width: '120px', height: 'auto', marginLeft: '40px', marginTop: '20px' }} />
          </Link>
